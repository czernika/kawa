 ...
 *
 * Most of the methods from https://github.com/illuminate/support/blob/master/Stringable.php
 */
...
class Stringable
{
     ...
     *
     * @param  \Kawa\Support\Stringable|string  $value
     * @return bool
     */
     ...
     * @param  int  $limit
     * @return \Kawa\Support\Collection
     */
